...
conf = {"es.nodes": "localhost" ,"es.port" : "9200","es.resource": "index_bank/type_bank","es.mapping.id": "doc_id","es.input.json": "true"}
...
def main():
	...
	rd_rt_all = rd_rtz.map(lambda g:(str(g[1]),json.dumps({'doc_id':str(g[1]),'city':g[0][3],'date':g[0][1],\
		...
		'building_materials': g[0][2][5],'complete_date': g[0][2][6],'shifting_area': float(g[0][2][7]or 0),\
